    ...
    <div class="app-container">
        <el-row>
            ...
            <el-col :span="20" :xs="24">
                ...
                <el-table v-loading="loading" :data="listAd" @selection-change="handleSelectionChange">
        ...
        <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                <el-row>
                    <!-- <el-col :span="12">
                        <el-form-item label="用户名" prop="username">
                            <el-input v-model="form.username" placeholder="请输入商户用户名" />
                        </el-form-item>
                    </el-col> -->
                    <el-col :span="24">
                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="商户链接" prop="telegarmUrl">
                            <el-input v-model="form.telegarmUrl" placeholder="请输入商户链接" />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                ...
                <el-row>
                    <el-col :span="20">
                        <el-form-item label="关联菜单" prop="botMenu">
                            <el-select v-model="form.botMenu" placeholder="请选择关联菜单">
                                <el-option v-for="item in menuList" :key="item.id" :label="item.value" :value="item.id">
                                </el-option>
                            </el-select>
                        </el-form-item>
...
import {
    ...
    listAdRenewal,
    checkExpire
} from "@/api/admin/advertise/listAd";
    ...
    methods: {
        ...
        getList() {
            ...
            listAds(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
                this.listAd = response.data.results;
            ...
            this.$refs["form"].validate(valid => {
                if (valid) {
                    if (this.form.id !== undefined) {
                        ...
                        updateListAd(this.form).then(response => {
                        ...
                        addListAd(this.form).then(response => {
